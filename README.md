...
2. três visualizações do campo — perspectiva isométrica, projeção ortográfica e
   vista axial (câmera alinhada com a linha de ação de `F`);
...
suficiente para alterar a visualização — nenhuma mudança no código é necessária.
